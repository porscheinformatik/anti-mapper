...
public interface StreamMerger<DTO, Entity>
{
     ...
     * @return a collection
     */
    Set<Entity> intoHashSet(Set<Entity> entities);
     ...
     * @return a collection
     */
    SortedSet<Entity> intoTreeSet(SortedSet<Entity> entities);
     ...
     * @return a collection
     */
    SortedSet<Entity> intoTreeSet(SortedSet<Entity> entities, Comparator<? super Entity> comparator);
     ...
     * @return a collection
     */
    List<Entity> intoArrayList(List<Entity> entities);
