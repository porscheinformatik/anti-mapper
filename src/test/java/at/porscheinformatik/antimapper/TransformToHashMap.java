...
public class TransformToHashMap extends AbstractMapperTest
{
    ...
    {
        Map<Character, String> dtos = this.transformAll((List<char[]>) null, BOARDING_PASS).toHashMap(GROUPER);
    ...
    public void testNullToHashMapOrEmpty()
    {
        Map<Character, String> dtos =
            this.transformAll((List<char[]>) null, BOARDING_PASS, Hint.OR_EMPTY).toHashMap(GROUPER);
    ...
    public void testToHashMap()
    {
        List<char[]> entities = toList("A1".toCharArray(), "A1".toCharArray(), "!B".toCharArray(), "C1".toCharArray(),
            "C2".toCharArray(), null);
        Map<Character, String> dtos = this.transformAll(entities, BOARDING_PASS).toHashMap(GROUPER);
    ...
    public void testToHashMapKeepNullAndUnmodifiable()
    {
        List<char[]> entities = toList("A1".toCharArray(), "A1".toCharArray(), "!B".toCharArray(), "C1".toCharArray(),
            "C2".toCharArray(), null);
        Map<Character, String> dtos =
            this.transformAll(entities, Hint.KEEP_NULL, Hint.UNMODIFIABLE, BOARDING_PASS).toHashMap(GROUPER);
