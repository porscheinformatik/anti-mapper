...
public class TransformGroupedMapToGroupedTreeSets extends AbstractMapperTest
{
    ...
    public void testNullToGroupedTreeSets()
    {
        Map<Character, SortedSet<String>> dtos =
            this.<Character> transformGrouped(null, BOARDING_PASS).toGroupedTreeSets();
    ...
    {
        Map<Character, SortedSet<String>> dtos =
            this.<Character> transformGrouped(null, BOARDING_PASS, Hint.OR_EMPTY).toGroupedTreeSets();
    ...
    public void testToGroupedTreeSets()
    {
        ...
        Map<Character, SortedSet<String>> dtos = this.transformGrouped(entities, BOARDING_PASS).toGroupedTreeSets();
    ...
    public void testToGroupedTreeSetsKeepNullAndUnmodifiable()
    {
        ...
        Map<Character, SortedSet<String>> dtos = this
            .transformGrouped(entities, Hint.KEEP_NULL, Hint.UNMODIFIABLE, BOARDING_PASS)
            .toGroupedTreeSets(STRING_COMPARATOR);
