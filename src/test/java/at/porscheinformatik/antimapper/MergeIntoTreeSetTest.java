...
public class MergeIntoTreeSetTest extends AbstractMapperTest
{
    ...
    public void testNullIntoNullTreeSet()
    {
        ...
        SortedSet<char[]> result = this.mergeAll(dtos, BOARDING_PASS).intoTreeSet(entities);
    ...
    public void testNullIntoNullTreeSetOrEmpty()
    {
        ...
        SortedSet<char[]> result =
            this.mergeAll(dtos, BOARDING_PASS, Hint.OR_EMPTY).intoTreeSet(entities, CHAR_ARRAY_COMPARATOR);
    ...
    public void testIntoNullTreeSet()
    {
        ...
        SortedSet<char[]> entities = null;
        SortedSet<char[]> result = this.mergeAll(dtos, BOARDING_PASS).intoTreeSet(entities, CHAR_ARRAY_COMPARATOR);
    ...
    public void testIntoTreeSetKeepNullAndUnmodifiable()
    {
        ...
        SortedSet<char[]> result =
            this.mergeAll(dtos, Hint.KEEP_NULL, Hint.UNMODIFIABLE, BOARDING_PASS).intoTreeSet(entities);
