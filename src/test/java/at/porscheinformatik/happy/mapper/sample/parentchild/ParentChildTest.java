...
public class ParentChildTest
{
    ...
    public void test()
    {
        ...
        ParentDTO dto = mapper.transform(intialEntity);
        ...
        assertThat(dto.getChilds().get(ChildType.A).get(0).getType(), equalTo(ChildType.A));
        ...
        assertThat(dto.getChilds().get(ChildType.A).get(1).getType(), equalTo(ChildType.A));
        ...
        assertThat(dto.getChilds().get(ChildType.A).get(2).getType(), equalTo(ChildType.A));
        ...
        assertThat(dto.getChilds().get(ChildType.B).get(0).getType(), equalTo(ChildType.B));
        ...
        assertThat(dto.getChilds().get(ChildType.B).get(1).getType(), equalTo(ChildType.B));
        ...
        assertThat(dto.getChilds().get(ChildType.C).get(0).getType(), equalTo(ChildType.C));

        ParentEntity entity = mapper.merge(dto, null);

        System.out.println(entity);

        assertThat(entity, notNullValue());
        assertThat(entity.getId(), equalTo(1));
        assertThat(entity.getName(), equalTo("Parent"));
        ...
        assertThat(childEntities.get(1).getName(), equalTo("A1"));
        ...
        assertThat(childEntities.get(2).getName(), equalTo("A3"));
        ...
        assertThat(childEntities.get(3).getName(), equalTo("B2"));
        ...
        assertThat(childEntities.get(4).getName(), equalTo("B1"));
